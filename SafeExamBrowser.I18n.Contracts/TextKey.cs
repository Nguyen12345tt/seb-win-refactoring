...
namespace SafeExamBrowser.I18n.Contracts
{
	...
	public enum TextKey
	{
		...
		// TODO: Translate the new text keys to all remaining languages once approved!
		ErrorDialog_CrashMessage,
		ErrorDialog_CrashTitle,
		ErrorDialog_IgnoreCrash,
		ErrorDialog_Ok,
		ErrorDialog_SendMail,
		ErrorDialog_SessionStartMessage,
		ErrorDialog_SessionStartTitle,
		ErrorDialog_ShutdownMessage,
		ErrorDialog_ShutdownTitle,
		ErrorDialog_StartupMessage,
		ErrorDialog_StartupTitle,
		...
		// TODO: Translate the new text keys to all remaining languages once approved!
		OperationStatus_FinalizeCrashLog,
		...
		// TODO: Translate the new text keys to all remaining languages once approved!
		OperationStatus_InitializeCrashLog,
